/*
 ============================================================================
 Name        : PruebaDeadlock.c
 Description : Prueba de Deadlock del TP CarpinchOS
 Status      : Beta - "Compila" pero necesita test run
 ============================================================================
 */
...
// TODO: Mover los sleep 1s a un valor de constante de algún .h
